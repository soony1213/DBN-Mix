...
class ResNext(nn.Module):
    def __init__(self, block, layers, groups=1, width_per_group=64, dropout=None, num_classes=1000, use_norm=False,
                 use_block = True, reduce_dimension=False, layer3_output_dim=None, layer4_output_dim=None, s=30):
        self.inplanes = 64
...
def resnext50(num_classes, use_norm=True, use_block=True):
    return ResNext(Bottleneck, [3, 4, 6, 3], groups=32, width_per_group=4, dropout=None,
